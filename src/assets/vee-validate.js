...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self),
      factory((global.VeeValidate = {}), global.Vue));
    ...
    RuleContainer.getTargetParamNames = function(rule, params) {
      ...
      if (Array.isArray(params)) {
        return params.filter(function(_, idx) {
          return (
            definition.params &&
            find(definition.params, function(p, i) {
      ...
      return Object.keys(params)
        .filter(function(key) {
          return (
            definition.params &&
            find(definition.params, function(p) {
  ...
  function _generateFieldError(
    ...
    var values = __assign(
      __assign(__assign(__assign({}, params || {}), data || {}), {
        _field_: field.name,
        _value_: value,
        _rule_: ruleName
      }),
    ...
    if (
      ...
      return {
        msg: _normalizeMessage(
          field.customMessages[ruleName],
          field.name,
          values
        ),
        rule: ruleName
  ...
  function _buildParams(provided, defined, crossTable) {
    ...
    if (
      !defined ||
      (defined.length < provided.length && Array.isArray(provided))
    ) {
  ...
  function resolveRules(vnode) {
    ...
    if (isTextInput(vnode)) {
      return normalizeRules(
        __assign(__assign({}, rules), resolveTextualRules(vnode))
      );
    }
  ...
  function onRenderUpdate(vm, value) {
    ...
    vm.validateSilent().then(
      vm.immediate || vm.flags.validated ? vm.applyResult : identity
    );
  }
  ...
  function addListeners(vm, node) {
    ...
    vm._inputEventName =
      vm._inputEventName || getInputEventName(node, findModel(node));
  ...
  var ValidationProvider = Vue.extend({
      ...
      fieldDeps: function() {
        ...
        return Object.keys(this.normalizedRules)
          ...
          .reduce(function(acc, rule) {
            var deps = RuleContainer.getTargetParamNames(
              rule,
              _this.normalizedRules[rule]
            );
    ...
    render: function(h) {
      ...
      extractVNodes(children).forEach(function(input) {
        _this._resolvedRules = getConfig().useConstraintAttrs
          ? resolveRules(input)
          : {};
  ...
  var ValidationObserver = Vue.extend({
    ...
    computed: {
      ctx: function() {
        ...
        return __spreadArrays(
          values(this.refs),
          Object.keys(this.inactiveRefs).map(function(key) {
            return {
              vid: key,
    ...
    methods: {
      subscribe: function(subscriber, kind) {
        ...
        this.refs = __assign(
          __assign({}, this.refs),
          ((_a = {}), (_a[subscriber.id] = subscriber), _a)
        );
        this.refsByName = __assign(
          __assign({}, this.refsByName),
          ((_b = {}), (_b[subscriber.name] = subscriber), _b)
        );
  ...
  function withValidation(component, mapProps) {
    ...
    hoc.render = function(h) {
      ...
      var props = __assign(
        __assign(
          __assign({}, this.$attrs),
          ((_a = {}), (_a[prop] = model && model.value), _a)
        ),
        mapProps(vctx)
      );
      return h(
